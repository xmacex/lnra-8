## LИRA-8. Organismic synthesizer for norns
...
LIRA-8, thereby *LИRA-8* has a lot of controls, so you will probably want MIDI and/or OSC controllers and [map](https://monome.org/docs/norns/control-clock/#map) them via the params menu.
...
LИRA-8 interface mimics those of LIRA-8 and LYRA-8. Those are both good to keep in front of you when you familiarize yourself with *LИRA-8*.
